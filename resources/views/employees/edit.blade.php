        ...
        <div class="card shadow rounded-4 p-4">
            <form action="{{ route('employee.update', $employee->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <textarea id="address" name="address" class="form-control" rows="3" placeholder="Enter address">{{ old('address', $employee->address) }}</textarea>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <select id="working_location" name="working_location" class="form-select">
                        ...
                        <option value="Office"
                            {{ old('working_location', $employee->working_location) == 'Office' ? 'selected' : '' }}>
                            Office</option>
                        <option value="Remote"
                            {{ old('working_location', $employee->working_location) == 'Remote' ? 'selected' : '' }}>
                            Remote</option>
                    </select>
                </div>
